...
void loop() {
  ...
  JsonDocument doc;
  DeserializationError result = deserializeJson(doc, incomingString);
  if (result) {    // Test if parsing succeeds.
        Serial.println("json parse err");
        Serial.println(incomingString);
    return;
  } else {
    mqttClient.publish(topic.c_str(), 0, false, incomingString, incomingString.length());
